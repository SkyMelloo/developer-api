...
- **[DEVELOPER_API.md](DEVELOPER_API.md)** - the full reference (auth, signing, every endpoint, rate limits, compatibility rules)
...
- [api-client](https://github.com/SkyMelloo/api-client) - Java client library (queueing, batching, backoff)
